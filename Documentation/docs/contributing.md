When suggesting new features, make sure it has a clear use case and play nice with existing features. When making pull requests, make sure to discuss it first in an issue.
